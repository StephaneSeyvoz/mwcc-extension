...
This plugin allows using Metrowerks CodeWarrior with the Mindc toolchain
(http://mind.ow2.org). It enables the use of MWCC-specific preprocessing,
compilation, and linking flags, as the original Mindc only supported GCC
and LD.
